...
<body>
  <header class="hero">
    <div class="hero-inner">
      ...
      <h1>豆瓣读书排行</h1>
      <p class="lede">从 Top 250、标签、豆列与丛书重新发现值得读的书。</p>
